...
# WSL2 VM. This script runs on the Windows host and relays 0.0.0.0:<ListenPort>
...
#
# Args:
#   -ListenPort   port to listen on (0.0.0.0:<port>). default 9223
...
Write-Host "agent-browser forwarder listening on 0.0.0.0:$ListenPort -> 127.0.0.1:$TargetPort"
[AbForwarder]::Run($ListenPort, '127.0.0.1', $TargetPort)
